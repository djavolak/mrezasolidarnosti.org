...
import Registersuccessbox from "./Registersuccessbox.js";

export default class RegistersuccessboxHandler extends BlockHandler {
    constructor({
                    contentEditorId,
                    lockBlockActions,
                    customBlockActions,
