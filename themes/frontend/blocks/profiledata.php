    ...
    <div id="profileData">
        ...
        <div id="profileDataInfo">
            ...
            <div id="profileDataStats">
                ...
                <a class="instructions buttonPrimary centered" href="/instrukcije-za-placanje" title="Kreiraj instrukcije za uplatu">
            ...
            <div id="profileDataLinks">
                ...
                <a href="/instrukcije-za-placanje" title="Instrukcije za uplatu" class="buttonPrimary centered">
