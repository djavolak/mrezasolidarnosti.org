<?php if($isDonorLoggedIn):?>
    <header id="mainHeader" class="loggedIn">
        ...
        <nav>
            <ul>
                <li>
                    <a href="/doniraj" title="Doniraj" class="<?=$slug === 'doniraj' ? 'active' : ''?>">
                ...
                <li>
                    <a href="/instrukcije-za-uplatu" title="Instrukcije za uplatu" class="<?=$slug === 'instrukcije-za-uplatu' ? 'active' : ''?>">
                        ...
                        <span>Instrukcije za uplatu</span>
                    </a>
                </li>
                <li>
                    <a href="/korisnicki-podaci" title="Korisnički podaci" class="<?=$slug === 'korisnicki-podaci' ? 'active' : ''?>">
                        ...
                        <span>Korisnički podaci</span>
                    </a>
                </li>
                <li>
                    <a href="/donor/logout" title="Odjavi se">
